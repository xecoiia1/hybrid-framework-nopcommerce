...
//Common class
public class BasePageJqueryUploadFiles {
	
	// Che giấu đi việc khởi tạo của 1 đối tượng
	public static BasePageJqueryUploadFiles getBasePageObj() {
		return new BasePageJqueryUploadFiles();
	}
